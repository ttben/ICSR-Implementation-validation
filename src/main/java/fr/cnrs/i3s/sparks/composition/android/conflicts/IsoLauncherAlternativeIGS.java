...
public class IsoLauncherAlternativeIGS {
    ...
    public static void main(String[] args) throws Exception {
        ...
        String outputPath = "target/spooned-iso-alternative-igs";
        ...
        List<Processor> processors = Arrays.asList(new AddNPGuard(accumulator), igsInliner);

        IsoLauncherAlternativeIGS seqLauncher = new IsoLauncherAlternativeIGS(inputPath, processors, outputPath, accumulator);
        seqLauncher.apply();
    }

    IsoLauncherAlternativeIGS(String inputPath, List<Processor> processors, String outputPath, Accumulator accumulator) {
